...
public class CsvJson {
    public static void csvJson(String file, String path) throws IOException {
        ...
        /**
         * Создал массив строк columnMapping, соедржащий инфу о колонках в CSV файле
         */
    ...
    /**
     * Передаем метод parseCSV в файловый ридер FileReader. Затем используя объект ColumnPositionMappingStrategy
     * указываем тип setType и тип колонок setColumnMapping. Далле, создаю экзмепляр CsvToBean с использованием билдера
     *
     *
     * @param columnMapping
     * @param filename
